...
import { 
  ...
  Ticket, BarChart3, ClipboardList, ShieldCheck, Settings, Zap, X, LogOut, AlertTriangle, Tag, Newspaper, CalendarCheck
} from 'lucide-react';
            ...
            <div className="p-6 text-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="flex-1 px-4 py-2.5 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-xl transition-colors shadow-sm shadow-red-200 flex items-center justify-center gap-2"
                >
